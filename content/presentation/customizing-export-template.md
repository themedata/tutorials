...
description = "Use custom template to export finished web page."
draft = false
...
title = "Using Custom Export Template"
type = "presentation"
...
partial = "goandtalk/cover/hero-dark-background-with-text-at-center"
  ...
  description = "to publish webpage"
  intro = "using Custom"
...
partial = "goandtalk/slides/alternate-text-and-big-icon-layer"
  ...
  intro = " "
  is_global = false
  title = "Using a Custom Export Template"
...
partial = "goandtalk/slides/alternate-text-and-big-icon-layer"
  ...
  [gmgt_section.data]
  content = "* JavaScript included in the custom export template __WILL__ be executed when the exported page is loaded\n* It is the user's responsibility to use common sense in selecting what to include in the custom export template "
  intro = " "
  is_global = false
  title = "Precaution"
    ...
    [gmgt_section.data.icons]
    icon_transform = "shrink-12 up-4"
    mini_icon = "mask"
    mini_icon_color = "black"
    outer_icon = "exclamation-triangle"
    width = 20.0
